...
//                     console.error(`get price on UNISWAPV2 error ${dex}
//                     *************************
...
//                 tokenAmount,
//                 contracts1.get(dex)!).catch(error => {
//                     console.error(`get price on UNISWAPV3 error ${dex}
//                     *************************
//                     tokenIn: ${tokenIn.address} 
//                     tokenout: ${tokenOut.address}
//                     amount: ${tokenAmount}
...
//         } catch(error) {
//             formatedAmountOutPrice.push(ZERO)
//         }
//     })
...
//         var bought: BigNumber = ZERO
//         var sell_for: BigNumber = ZERO
//         try {
//             // @ts-ignore
//             bought = buyDexType[index] == 0 ? price[1] : price
//         } catch(error) {
//             console.log(`couldn't get data from dex, bought `)
//             bought = ZERO
//         }
//         try {
//             // @ts-ignore
//             sell_for = sellDexType[index] == 0 ? amountSellPrice[index][1] : amountSellPrice[index]
//         } catch(error) {
//             console.log(`couldn't get data from dex, sell_for`)
//             sell_for = ZERO
//         }
//         if (sell_for == undefined) console.log('undefined sell for')
